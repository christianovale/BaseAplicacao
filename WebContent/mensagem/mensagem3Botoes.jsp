...
<%
	...
	String servlet3 = (String) request.getAttribute("servlet3");
	String botao3 = (String) request.getAttribute("botao3");
	String acao3 = (String) request.getAttribute("acao3");
%>
				...
				<table width="75%" border="0" cellpadding="0" cellspacing="0">
			       <tr>
		             ...
		             <td width="33%" valign="top" align="center">
		        		<form name="formDados" method="post" action="<%=servlet3%>">
							<input name="acao" type="hidden" id="acao" value="<%=acao3%>">
							<input type="image" src="imagem/botao/<%=botao3%>.gif">
						</form>
					</td>					
		          </tr>
               </table>
